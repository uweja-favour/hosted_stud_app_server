...
import com.xapps.selftest.infrastructure.serialization.encoder_and_decoder.KotlinxSerializationDecoder
import com.xapps.selftest.infrastructure.serialization.encoder_and_decoder.KotlinxSerializationEncoder
import com.xapps.selftest.infrastructure.serialization.http_message_reader_and_writer.KotlinxSerializationJsonReader
import com.xapps.selftest.infrastructure.serialization.http_message_reader_and_writer.KotlinxSerializationJsonWriter
...
class WebFluxSerializationConfig(
    ...
    @Bean
    fun kotlinJson(): Json = SelfTestJsonEngine.json

    @Bean
    fun serializersModule(): SerializersModule = SelfTestJsonEngine.module
