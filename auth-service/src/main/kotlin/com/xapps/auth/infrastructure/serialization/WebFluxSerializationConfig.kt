...
import com.xapps.auth.infrastructure.serialization.encoder_and_decoder.KotlinxSerializationDecoder
import com.xapps.auth.infrastructure.serialization.encoder_and_decoder.KotlinxSerializationEncoder
import com.xapps.auth.infrastructure.serialization.http_message_reader_and_writer.KotlinxSerializationJsonReader
import com.xapps.auth.infrastructure.serialization.http_message_reader_and_writer.KotlinxSerializationJsonWriter
...
class WebFluxSerializationConfig(
    ...
    @Bean
    fun kotlinJson(): Json = AuthJsonEngine.json

    @Bean
    fun serializersModule(): SerializersModule = AuthJsonEngine.module
