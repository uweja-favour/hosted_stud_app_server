...
import com.xapps.classroom.infrastructure.serialization.encoder_and_decoder.KotlinxSerializationDecoder
import com.xapps.classroom.infrastructure.serialization.encoder_and_decoder.KotlinxSerializationEncoder
import com.xapps.classroom.infrastructure.serialization.http_message_reader_and_writer.KotlinxSerializationJsonReader
import com.xapps.classroom.infrastructure.serialization.http_message_reader_and_writer.KotlinxSerializationJsonWriter
...
class WebFluxSerializationConfig(
    ...
    @Bean
    fun kotlinJson(): Json = ClassroomJsonEngine.json

    @Bean
    fun serializersModule(): SerializersModule = ClassroomJsonEngine.module
